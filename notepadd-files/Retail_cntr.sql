...
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pi_retail_app_role;
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO s_sharma_techm;
...
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pi_retail_app_role;
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO s_sharma_techm;
...
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pi_retail_app_role;
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO s_sharma_techm;
...
GRANT INSERT, UPDATE, DELETE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT INSERT, UPDATE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pi_retail_app_role;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO s_sharma_techm;
...
GRANT INSERT, UPDATE, DELETE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT INSERT, UPDATE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pi_retail_app_role;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO s_sharma_techm;
...
GRANT INSERT, UPDATE, DELETE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT INSERT, UPDATE, SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pi_retail_app_role;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO s_sharma_techm;
...
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pidbusr;
GRANT ALL ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_id TO pirousr;
...
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pidbusr;
GRANT ALL ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_hist_id TO pirousr;
...
GRANT SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pi_retail_usr_role;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pi_retail_mgr_role WITH GRANT OPTION;
GRANT USAGE, SELECT ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pidbusr;
GRANT ALL ON SEQUENCE retail_cntr.seq_cmdmnt_cnee_exclusion_stg_id TO pirousr;
---------------------------------------
...
ALTER TABLE retail_cntr.cmdmnt_cnee_exclusion OWNER TO pi_admin;
GRANT ALL ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pi_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pidbusr;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pirousr;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion TO pi_purge_usr;

ALTER TABLE retail_cntr.cmdmnt_cnee_exclusion_hist OWNER TO pi_admin;
GRANT ALL ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pi_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pidbusr;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pirousr;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_hist TO pi_purge_usr;


ALTER TABLE retail_cntr.cmdmnt_cnee_exclusion_stg OWNER TO pi_admin;
GRANT ALL ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pi_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pidbusr;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pirousr;
...
GRANT SELECT ON TABLE retail_cntr.cmdmnt_cnee_exclusion_stg TO pi_purge_usr;
==========================================

sit:-
--------
grant connect ON DATABASE pi_retail_cntr_db to pirousr;
grant connect ON DATABASE pi_retail_cntr_db to pidbusr;
GRANT USAGE ON SCHEMA retail_cntr TO pidbusr;
GRANT USAGE ON SCHEMA retail_cntr TO pirousr;
